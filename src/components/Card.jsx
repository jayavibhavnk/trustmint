...
import Saras from "../asset/saras.jpg";
import Nischith from "../asset/nischith.png";
import Jayvibhav from "../asset/jayvibhav.png";
import Saksham from "../asset/saksham.jpg";
import Manik from "../asset/manik.png";

function Card() {
  return (
    <div className="flex flex-wrap justify-center">
      <div className="w-full max-w-xs bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-3">
